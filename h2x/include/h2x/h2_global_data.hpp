...
#ifndef H2X_GLOBAL_DATA_HPP
#define H2X_GLOBAL_DATA_HPP
...
namespace h2x {
    ...
    inline constexpr const char* global_client_preface = "PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n";
    inline constexpr int32_t global_client_preface_len = 24;

    inline constexpr int32_t global_frame_max_limit_size = 16384;
    ...
    constexpr auto G_LITERAL_WITHOUT_INDEXING  = global_hpack_ops[2];
    constexpr auto G_LITERAL_NEVER_INDEXED  = global_hpack_ops[3];
    constexpr auto G_DYNAMIC_TABLE_SIZE_UPDATE  = global_hpack_ops[4];

    ////////////////////////////////////////////////////////////////////////////////

    /**
     * @brief HPACK 表项抽象，表示静态/动态表中的一条记录。
     *
     * 字段说明：
     * - index_: 在表中的索引（静态表与动态表合并使用偏移）。
     * - name_/value_: 可选字符串，若为 std::nullopt 表示该条目引用外部静态表。
     * - hash_: 名/值对的哈希，用于快速查找。
     * - type_: 指示 HPACK 操作类型的元数据指针。
     */
    struct header_entry {
        int64_t index_;
    ...
    static const header_entry global_static_header_table[] = {
        ...
        {4, ":path", "/", 4184852371, &G_INDEXED},
        {5, ":path", "/index.html", 1415576752, &G_INDEXED},
        {6, ":scheme", "http", 4159895042, &G_INDEXED},
        {7, ":scheme", "https", 3296326627, &G_INDEXED},
        {8, ":status", "200", 1883682711, &G_INDEXED},
        {9, ":status", "204", 1816572235, &G_INDEXED},
        {10, ":status", "206", 1850127473, &G_INDEXED},
        {11, ":status", "304", 3987688224, &G_INDEXED},
        {12, ":status", "400", 2467831201, &G_INDEXED},
        {13, ":status", "404", 2534941677, &G_INDEXED},
        {14, ":status", "500", 343979894, &G_INDEXED},
        {15, "accept-charset", "", 3664010344, &G_INDEXED},
        {16, "accept-encoding", "gzip, deflate", 4136250384, &G_INDEXED},
        {17, "accept-language", "", 1979086614, &G_INDEXED},
        {18, "accept-ranges", "", 1713753958, &G_INDEXED},
        {19, "accept", "", 136609321, &G_INDEXED},
        {20, "access-control-allow-origin", "", 2710797292, &G_INDEXED},
        {21, "age", "", 742476188, &G_INDEXED},
        {22, "allow", "", 2930878514, &G_INDEXED},
        {23, "authorization", "", 2436257726, &G_INDEXED},
        {24, "cache-control", "", 1355326669, &G_INDEXED},
        {25, "content-disposition", "", 3889184348, &G_INDEXED},
        {26, "content-encoding", "", 65203592, &G_INDEXED},
        {27, "content-language", "", 24973587, &G_INDEXED},
        {28, "content-length", "", 1308181789, &G_INDEXED},
        {29, "content-location", "", 2302364718, &G_INDEXED},
        {30, "content-range", "", 3555523146, &G_INDEXED},
        {31, "content-type", "", 4244048277, &G_INDEXED},
        {32, "cookie", "", 2007449791, &G_INDEXED},
        {33, "date", "", 3564297305, &G_INDEXED},
        {34, "etag", "", 113792960, &G_INDEXED},
        {35, "expect", "", 2530896728, &G_INDEXED},
        {36, "expires", "", 1049544579, &G_INDEXED},
        {37, "from", "", 2513272949, &G_INDEXED},
        {38, "host", "", 2952701295, &G_INDEXED},
        {39, "if-match", "", 3597694698, &G_INDEXED},
        {40, "if-modified-since", "", 2213050793, &G_INDEXED},
        {41, "if-none-match", "", 2536202615, &G_INDEXED},
        {42, "if-range", "", 2340978238, &G_INDEXED},
        {43, "if-unmodified-since", "", 3794814858, &G_INDEXED},
        {44, "last-modified", "", 3226950251, &G_INDEXED},
        {45, "link", "", 232457833, &G_INDEXED},
        {46, "location", "", 200649126, &G_INDEXED},
        {47, "max-forwards", "", 1826162134, &G_INDEXED},
        {48, "proxy-authenticate", "", 2709445359, &G_INDEXED},
        {49, "proxy-authorization", "", 2686392507, &G_INDEXED},
        {50, "range", "", 4208725202, &G_INDEXED},
        {51, "referer", "", 3969579366, &G_INDEXED},
        {52, "refresh", "", 3572655668, &G_INDEXED},
        {53, "retry-after", "", 3336180598, &G_INDEXED},
        {54, "server", "", 1085029842, &G_INDEXED},
        {55, "set-cookie", "", 1848371000, &G_INDEXED},
        {56, "strict-transport-security", "", 4138147361, &G_INDEXED},
        {57, "transfer-encoding", "", 3719590988, &G_INDEXED},
        {58, "user-agent", "", 606444526, &G_INDEXED},
        {59, "vary", "", 1085005381, &G_INDEXED},
        {60, "via", "", 1762798611, &G_INDEXED},
    ...
    inline constexpr uint8_t HPACK_HAS_BITS[9] = {
        0x00, 0x01, 0x03, 0x07, 0x0F, 0x1F, 0x3F, 0x7F, 0xFF
    };

    // 定义 huffman 编码的符号
    using huffman_sym = std::pair<uint32_t, uint32_t>;
    ...
    //
    // first 是 bits, second 是 huffman code
    //
    inline constexpr huffman_sym global_huffman_table[] = {
    ...
    inline constexpr huffman_node global_huffman_tree[][16] = {
        /* 0 */
        {
            {0x04, 0, 0},
            {0x05, 0, 0},
